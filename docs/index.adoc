...
* TODO           : Added build support for JDK 11 and upgraded gradlew to 5.6 and GRPC to 1.23.0
* 0.7.1-Beta-rc1 : Generated against LND 0.7.1 API, basically the same as 0.7.1-rc1.
