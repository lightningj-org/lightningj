 ...
 *                                                                       *
 *************************************************************************/
package org.lightningj.lnd.wrapper.signer
...
/**
 * Unit tests for Signer API classes.
 * <p>
 ...
 */
class SignerAPISpec extends Specification {

    // Initialization is tested in SynchronousAPISpec

    def asyncApi = new AsynchronousSignerAPI(Mock(ManagedChannel))
    def syncApi = new SynchronousSignerAPI(Mock(ManagedChannel))
