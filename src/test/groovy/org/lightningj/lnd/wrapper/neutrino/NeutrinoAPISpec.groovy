 ...
 */
class NeutrinoAPISpec extends Specification {

    // Initialization is tested in SynchronousAPISpec

    def asyncApi = new AsynchronousNeutrinoAPI(Mock(ManagedChannel))
    def syncApi = new SynchronousNeutrinoAPI(Mock(ManagedChannel))
