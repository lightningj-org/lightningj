...
import org.lightningj.lnd.wrapper.stateservice.SynchronousStateServiceAPI
import org.lightningj.lnd.wrapper.stateservice.AsynchronousStateServiceAPI
 ...
 */
class StateServiceIntegrationSpec extends Specification{
    ...
    SynchronousStateServiceAPI synchronousAPI
    AsynchronousStateServiceAPI asynchronousAPI
    ...
    def setup(){
        asynchronousAPI = new AsynchronousStateServiceAPI(lndHost,lndPort,tlsCertPath, macaroonPath)
        synchronousAPI = new SynchronousStateServiceAPI(lndHost,lndPort,tlsCertPath, macaroonPath)
    }

    //@Ignore // Wait until proper instructions on how to enable to API.
    def "Test to verify state service api is available"(){
        expect:
        synchronousAPI.getState() != null
    }
